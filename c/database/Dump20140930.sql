...
INSERT INTO `cbentity` VALUES (1,'system_manager','system manager entity is only for cbsuper profile ');
...
INSERT INTO `cbprofile` VALUES (1,'cbsuper','cbsuper is a super user of entire system including everything.');
...
INSERT INTO `cbprofiledetail` VALUES (1,1,1,2),(3,1,2,2);
...
INSERT INTO `cbsubentity` VALUES (1,'alert_system','alert system will provide different types of alert',1),(2,'users','list users and its tree with their access type and',1);
...
INSERT INTO `cbuser` VALUES (1,'super','super',1,1,NULL);
...
INSERT INTO `cbusertype` VALUES (1,'superuser','super user havin all access of the system');
...
-- Dump completed on 2014-09-30  6:52:01
