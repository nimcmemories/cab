...
public class BikeDetails  extends BaseBean {
	...
	public JSONObject getJsonObj(){
		...
		try{
			jsonObject.put("bikeId", bikeDetailsId);
			jsonObject.put("pertnerDetailsId", partnerDetails.getPartnerDetailsId());
			jsonObject.put("pertnerDetailsName", partnerDetails.getPartnerTittle());
			jsonObject.put("bikeName", bikeName);
			jsonObject.put("description",description);
			jsonObject.put("per_hour_rate", perHourRate);
